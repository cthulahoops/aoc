...
command! -nargs=1 CountVertical echo CountVerticalString(<q-args>)

" Optional: Command to highlight matches
...
map <leader>cv :so day4.vim<CR>:HLMatches<Space>XMAS<CR>
